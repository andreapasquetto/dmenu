...
static Fnt *xfont_create(Drw *drw, const char *fontname, FcPattern *fontpattern)
{
   ...
   * This is a workaround for a BadLength error from Xft with color glyphs. Modelled on the Xterm workaround.
   * See:
 ...
 * The caller has to call free(3) on the returned color scheme when done using it.
 */
